...
//	+"  `id` INT NOT NULL AUTO_INCREMENT,\r\n"+"  `name` VARCHAR(30) NOT NULL,\r\n"+"  `city` VARCHAR(45) NOT NULL,\r\n"+"  `birthday` DATE NOT NULL,\r\n"+"  `hobby` VARCHAR(45) NOT NULL,\r\n"+"  PRIMARY KEY (`id`));";
	// public static final String DROP_TABLE_PERSONS = "DROP TABLE
	// `java129`.`persons`";
...
//	+"  `id` INT NOT NULL AUTO_INCREMENT,\r\n"+"  `name` VARCHAR(45) NOT NULL,\r\n"+"  PRIMARY KEY (`id`));\r\n"+"";
	...
	// private static final String CREATE_TABLE_COUPONS = "CREATE TABLE
	// `java129`.`coupons` (\r\n"
	...
	// `java129`.`companies` (`id`)\r\n"+" ON DELETE NO ACTION\r\n"+" ON UPDATE NO
	// ACTION,\r\n"+" CONSTRAINT `category_id`\r\n"+" FOREIGN KEY
	// (`category_id`)\r\n"+" REFERENCES `java129`.`categories` (`id`)\r\n"+" ON
	// DELETE NO ACTION\r\n"+" ON UPDATE NO ACTION);";

	// private static final String CREATE_TABLE_CUSTOMERS_VS_COUPONS = "CREATE TABLE
	// `java129`.`customers_vs_coupons` (\r\n"
	// +" `customer_id` INT NOT NULL,\r\n"+" `coupon_id` INT NOT NULL,\r\n"+"
	// PRIMARY KEY (`customer_id`, `coupon_id`),\r\n"+" INDEX `coupon_id_idx`
	// (`coupon_id` ASC) VISIBLE,\r\n"+" CONSTRAINT `customer_id`\r\n"+" FOREIGN KEY
